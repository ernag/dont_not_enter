...
#define BTPS_CONFIGURATION_SPP_DEFAULT_RECEIVE_BUFFER_SIZE                (BTPS_CONFIGURATION_SPP_DEFAULT_FRAME_SIZE * 2) // Note: this was *6, changed by KL
#define BTPS_CONFIGURATION_SPP_DEFAULT_FRAME_SIZE                          1000
