...
copy /Y ..\..\..\mqx\source\psp\cortex\MK20D7.h  .
...
if /I "%target%" == "debug"   copy /Y ..\..\..\mqx\build\uv4\twrk20d72m_IntFlashDebug\psp_twrk20d72m_d.lib .
if /I "%target%" == "release" copy /Y ..\..\..\mqx\build\uv4\twrk20d72m_IntFlashRelease\psp_twrk20d72m.lib .
goto comp_done
