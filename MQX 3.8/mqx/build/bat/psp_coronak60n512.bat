...
if /I "%target%" == "debug"   copy /Y ..\..\..\mqx\build\uv4\coronak60n512_IntFlashDebug\psp_coronak60n512_d.lib .
if /I "%target%" == "release" copy /Y ..\..\..\mqx\build\uv4\coronak60n512_IntFlashRelease\psp_coronak60n512.lib .
goto comp_done
