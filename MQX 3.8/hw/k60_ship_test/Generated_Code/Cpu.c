...
void PE_low_level_init(void)
{
  ...
  /* SIM_SCGC4: LLWU=1,VREF=0,CMP=0,USBOTG=0,UART3=0,UART2=0,UART1=0,UART0=0,I2C1=0,I2C0=0,CMT=0,EWM=0 */
  ...
  /* PORTE_PCR1: ISF=0,IRQC=0x0A,MUX=1,PFE=0,PE=1,PS=1 */
  ...
  /* PORTE_DFER: DFE&=~2 */
  PORTE_DFER &= (uint32_t)~(uint32_t)(PORT_DFER_DFE(0x02));                                                   
  /* PORTE_DFCR: CS=0 */
