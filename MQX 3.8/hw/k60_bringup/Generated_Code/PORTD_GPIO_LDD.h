...
#define PORTD_GPIO_LDD_Init_METHOD_ENABLED /*!< Init method of the component PORTD_GPIO_LDD is enabled (generated) */
#define PORTD_GPIO_LDD_Deinit_METHOD_ENABLED /*!< Deinit method of the component PORTD_GPIO_LDD is enabled (generated) */
#define PORTD_GPIO_LDD_SetFieldValue_METHOD_ENABLED /*!< SetFieldValue method of the component PORTD_GPIO_LDD is enabled (generated) */
#define PORTD_GPIO_LDD_GetFieldValue_METHOD_ENABLED /*!< GetFieldValue method of the component PORTD_GPIO_LDD is enabled (generated) */
#define PORTD_GPIO_LDD_ClearFieldBits_METHOD_ENABLED /*!< ClearFieldBits method of the component PORTD_GPIO_LDD is enabled (generated) */
#define PORTD_GPIO_LDD_SetFieldBits_METHOD_ENABLED /*!< SetFieldBits method of the component PORTD_GPIO_LDD is enabled (generated) */
#define PORTD_GPIO_LDD_ToggleFieldBits_METHOD_ENABLED /*!< ToggleFieldBits method of the component PORTD_GPIO_LDD is enabled (generated) */
#define PORTD_GPIO_LDD_SetFieldInputDirection_METHOD_ENABLED /*!< SetFieldInputDirection method of the component PORTD_GPIO_LDD is enabled (generated) */
#define PORTD_GPIO_LDD_SetFieldOutputDirection_METHOD_ENABLED /*!< SetFieldOutputDirection method of the component PORTD_GPIO_LDD is enabled (generated) */
#define PORTD_GPIO_LDD_ConnectPin_METHOD_ENABLED /*!< ConnectPin method of the component PORTD_GPIO_LDD is enabled (generated) */
