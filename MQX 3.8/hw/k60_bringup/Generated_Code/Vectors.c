...
**     Date/Time   : 2013-08-08, 08:25, # CodeGen: 102
**     Abstract    :
**
**     Settings    :
**
...
** @file Vectors.c                                                  
** @version 01.04
** @date 2013-08-08, 08:25, # CodeGen: 102
** @brief
**
*/         
/*!
...
*/         
  ...
  __declspec(vectortable) const tVectorTable __vect_table = { /* Interrupt vector table */
    ...
    (tIsrFunc)&RNG1_Interrupt,         /* 0x27  0x0000009C   8   ivINT_RNG                      used by PE */
    (tIsrFunc)&Cpu_ivINT_I2C0,         /* 0x28  0x000000A0   -   ivINT_I2C0                     unused by PE */
    (tIsrFunc)&I2C1_Interrupt,         /* 0x29  0x000000A4   8   ivINT_I2C1                     used by PE */
    ...
    (tIsrFunc)&UART0_BT_Interrupt,     /* 0x3D  0x000000F4   8   ivINT_UART0_RX_TX              used by PE */
    (tIsrFunc)&UART0_BT_Interrupt,     /* 0x3E  0x000000F8   8   ivINT_UART0_ERR                used by PE */
    ...
    (tIsrFunc)&UART3_WIFI_Interrupt,   /* 0x43  0x0000010C   8   ivINT_UART3_RX_TX              used by PE */
    (tIsrFunc)&UART3_WIFI_Interrupt,   /* 0x44  0x00000110   8   ivINT_UART3_ERR                used by PE */
    ...
    (tIsrFunc)&TU2_Interrupt,          /* 0x4F  0x0000013C   5   ivINT_FTM1                     used by PE */
    ...
    (tIsrFunc)&PORTE_ISR,              /* 0x6B  0x000001AC   0   ivINT_PORTE                    used by PE */
