...
static UART3_WIFI_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
/* {Default RTOS Adapter} Global variable used for passing a parameter into ISR */
static UART3_WIFI_TDeviceDataPtr INT_UART3_RX_TX__DEFAULT_RTOS_ISRPARAM;
/* {Default RTOS Adapter} Global variable used for passing a parameter into ISR */
static UART3_WIFI_TDeviceDataPtr INT_UART3_ERR__DEFAULT_RTOS_ISRPARAM;
...
LDD_TDeviceData* UART3_WIFI_Init(LDD_TUserData *UserDataPtr)
{
  ...
  UART3_WIFI_TDeviceDataPtr DeviceDataPrv;
  ...
  UART_PDD_SetBaudRate(UART3_BASE_PTR, 13U); /* Set the baud rate register. */
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_UART3_WIFI_ID,DeviceDataPrv);
...
{
  UART3_WIFI_TDeviceDataPtr DeviceDataPrv = (UART3_WIFI_TDeviceDataPtr)DeviceDataPtr;
...
** ===================================================================
*/
static void InterruptRx(UART3_WIFI_TDeviceDataPtr DeviceDataPrv)
{
  ...
  if (DeviceDataPrv->InpDataNumReq != 0x00U) { /* Is the receive block operation pending? */
    *(DeviceDataPrv->InpDataPtr++) = (uint8_t)Data; /* Put an 8-bit character to the receive buffer */
    ...
    if (DeviceDataPrv->InpRecvDataNum == DeviceDataPrv->InpDataNumReq) { /* Is the requested number of characters received? */
      ...
      UART3_WIFI_OnBlockReceived(DeviceDataPrv->UserDataPtr);
    }
  }
}
...
** ===================================================================
*/
static void InterruptTx(UART3_WIFI_TDeviceDataPtr DeviceDataPrv)
{
  ...
  if (DeviceDataPrv->OutSentDataNum < DeviceDataPrv->OutDataNumReq) { /* Is number of sent characters less than the number of requested incoming characters? */
    ...
    if (DeviceDataPrv->OutSentDataNum == DeviceDataPrv->OutDataNumReq) {
      DeviceDataPrv->OutDataNumReq = 0x00U; /* Clear the counter of characters to be send by SendBlock() */
      UART3_WIFI_OnBlockSent(DeviceDataPrv->UserDataPtr);
    }
  } else {
...
PE_ISR(UART3_WIFI_Interrupt)
{
  ...
  UART3_WIFI_TDeviceDataPtr DeviceDataPrv = INT_UART3_RX_TX__DEFAULT_RTOS_ISRPARAM;
