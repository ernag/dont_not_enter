...
LDD_TDeviceData* SPI2_Flash_Init(LDD_TUserData *UserDataPtr)
{
  ...
  SPI2_MCR = (SPI_MCR_ROOE_MASK | SPI_MCR_PCSIS(0x01) | SPI_MCR_HALT_MASK); /* Set Configuration register */
  ...
  /* SPI2_CTAR0: DBR=1,FMSZ=7,CPOL=1,CPHA=1,LSBFE=0,PCSSCK=0,PASC=0,PDT=0,PBR=3,CSSCK=0,ASC=0,DT=0,BR=2 */
...
void SPI2_Flash_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  SPI2_MCR = (SPI_MCR_MDIS_MASK | SPI_MCR_HALT_MASK); /* Disable device */
...
LDD_TError SPI2_Flash_ReceiveBlock(LDD_TDeviceData *DeviceDataPtr, LDD_TData *BufferPtr, uint16_t Size)
{
  ...
  EnterCritical();
  ((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr)->InpDataPtr = BufferPtr; /* Store a pointer to the input data. */
...
LDD_TError SPI2_Flash_SendBlock(LDD_TDeviceData *DeviceDataPtr, LDD_TData *BufferPtr, uint16_t Size)
{
  ...
  /* {Default RTOS Adapter} Critical section begin, general PE function is used */
  EnterCritical();
  ((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr)->OutDataPtr = BufferPtr; /* Set a pointer to the output data. */
