...
LDD_TDeviceData* SPI0_WIFI_Init(LDD_TUserData *UserDataPtr)
{
  ...
  SPI0_MCR = (SPI_MCR_ROOE_MASK | SPI_MCR_PCSIS(0x01) | SPI_MCR_HALT_MASK); /* Set Configuration register */
  ...
  /* SPI0_CTAR0: DBR=1,FMSZ=0x0F,CPOL=1,CPHA=0,LSBFE=0,PCSSCK=0,PASC=0,PDT=0,PBR=0,CSSCK=0,ASC=0,DT=0,BR=0 */
  SPI0_CTAR0 = (SPI_CTAR_DBR_MASK | SPI_CTAR_FMSZ(0x0F) | SPI_CTAR_CPOL_MASK); /* Set Clock and Transfer Attributes register */
...
void SPI0_WIFI_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  /* SPI0_MCR: MSTR=0,CONT_SCKE=0,DCONF=0,FRZ=0,MTFE=0,PCSSE=0,ROOE=0,??=0,??=0,PCSIS=0,DOZE=0,MDIS=1,DIS_TXF=0,DIS_RXF=0,CLR_TXF=0,CLR_RXF=0,SMPL_PT=0,??=0,??=0,??=0,??=0,??=0,??=0,??=0,HALT=1 */
  SPI0_MCR = (SPI_MCR_MDIS_MASK | SPI_MCR_HALT_MASK); /* Disable device */
...
LDD_TError SPI0_WIFI_ReceiveBlock(LDD_TDeviceData *DeviceDataPtr, LDD_TData *BufferPtr, uint16_t Size)
{
  ...
  EnterCritical();
  ((SPI0_WIFI_TDeviceDataPtr)DeviceDataPtr)->InpDataPtr = BufferPtr; /* Store a pointer to the input data. */
...
LDD_TError SPI0_WIFI_SendBlock(LDD_TDeviceData *DeviceDataPtr, LDD_TData *BufferPtr, uint16_t Size)
{
  ...
  /* {Default RTOS Adapter} Critical section begin, general PE function is used */
  EnterCritical();
  ((SPI0_WIFI_TDeviceDataPtr)DeviceDataPtr)->OutDataPtr = BufferPtr; /* Set a pointer to the output data. */
