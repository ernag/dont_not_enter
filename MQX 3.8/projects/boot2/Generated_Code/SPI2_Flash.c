...
**            Clock rate                                   : 1.000576 탎
**            Delay between chars                          : 0.250144 탎
...
**         Enable             - LDD_TError SPI2_Flash_Enable(LDD_TDeviceData *DeviceDataPtr);
**         Disable            - LDD_TError SPI2_Flash_Disable(LDD_TDeviceData *DeviceDataPtr);
...
/*
** ===================================================================
**     Method      :  SPI2_Flash_Enable (component SPIMaster_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
LDD_TError SPI2_Flash_Enable(LDD_TDeviceData *DeviceDataPtr)
{
  if (!((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr)->EnUser) { /* Is the device disabled by user? */
    ((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr)->EnUser = TRUE; /* If yes then set the flag "device enabled" */
    HWEnDi((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr); /* Enable the device */
  }
  return ERR_OK;                       /* OK */
}
...
/*
** ===================================================================
**     Method      :  SPI2_Flash_Disable (component SPIMaster_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
LDD_TError SPI2_Flash_Disable(LDD_TDeviceData *DeviceDataPtr)
{
  if (((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr)->EnUser) { /* Is the device enabled by user? */
    ((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr)->EnUser = FALSE; /* If yes then set the flag "device disabled" */
    HWEnDi((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr); /* Disable the device */
  }
  return ERR_OK;                       /* OK */
}
...
static void HWEnDi(LDD_TDeviceData *DeviceDataPtr)
{
  if (((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr)->EnUser) { /* Enable device? */
    ((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr)->OutDataNumReq = 0x00U; /* Clear the counter of requested outgoing characters. */
    ((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr)->OutSentDataNum = 0x00U; /* Clear the counter of sent characters. */
    ((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr)->InpDataNumReq = 0x00U; /* Clear the counter of requested incoming characters. */
    ((SPI2_Flash_TDeviceDataPtr)DeviceDataPtr)->InpRecvDataNum = 0x00U; /* Clear the counter of received characters. */
