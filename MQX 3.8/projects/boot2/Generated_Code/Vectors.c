...
*/         
  ...
  __declspec(vectortable) const tVectorTable __vect_table = { /* Interrupt vector table */
    ...
    (tIsrFunc)&I2C2_Interrupt,         /* 0x29  0x000000A4   8   ivINT_I2C1                     used by PE */
    ...
    (tIsrFunc)&isr_Button__DEPCRECATED,/* 0x67  0x0000019C   0   ivINT_PORTA                    used by PE */
    ...
    (tIsrFunc)&isr_PORTD,              /* 0x6A  0x000001A8   8   ivINT_PORTD                    used by PE */
    (tIsrFunc)&isr_PORTE,              /* 0x6B  0x000001AC   0   ivINT_PORTE                    used by PE */
