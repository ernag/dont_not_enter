...
#define ptc16 ((LDD_GPIO_TBitField)0)

/* Definition of implementation constants */
#define GPIO1_ALLOCATED_PINS_MASK 0x00010000U /* Mask of all allocated pins from the port */
...
#define GPIO1_ptc16_START_BIT 16u      /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_ptc16_MASK 0x00010000u   /* Mask of the bits allocated by the bit field (within the port) */
