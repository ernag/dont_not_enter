...
#define HCI_PACKET_PACKET_LENGTH_HCI_PACKET_HEADER_MASK        ((unsigned int)1 << ((sizeof(unsigned int) * 8) - 1))
#define HCI_PACKET_PACKET_LENGTH_HCI_PACKET_DATA_LENGTH_MASK   (~HCI_PACKET_PACKET_LENGTH_HCI_PACKET_HEADER_MASK)
