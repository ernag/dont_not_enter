TSS Libraries for GCC compiler in CodeWarrior for MCU v 10.3 or higher
=================================================================================

This folder contains platform-dependent TSS precompiled libraries 
for GCC compiler in CodeWarrior for MCU v 10.3 or higher. 
...
GCC compiler in CodeWarrior for MCU v 10.3 or higher:
---------------------------------------------------------------------------------
libTSS_KXX_M0.a     - ARM®Cortex™-M0 Kinetis platform
libTSS_KXX_M4.a     - ARM®Cortex™-M4 Kinetis platform
libTSS_KXX_M4_FPU.a - library for ARM®Cortex™-M4 Kinetis platform supported FPU with hard vfp passing
